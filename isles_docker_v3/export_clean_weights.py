...
Reads training checkpoints from data/nnunet_results/Dataset001_ISLES26,
strips optimizer states, and writes clean, lightweight inference checkpoints
into isles_docker_v3/model/Dataset001_ISLES26/.
"""
...
MODELS = [
    ...
    {
        "folder": "nnUNetTrainerWithLogging__nnUNetResEncUNetMPlans__3d_fullres",
        "label": "ResEnc",
    },
]
...
def process_model(model_info):
    ...
    for fold in FOLDS:
        ...
        # Keep ONLY what nnUNetPredictor uses for inference
        clean_ckpt = {
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Done! Clean model directory total size: {total_gb:.2f} GB")
